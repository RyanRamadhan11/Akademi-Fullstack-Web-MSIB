...
// proses edit data
// tangkap request id edit dari url (setelah klik tombol eit/icon pencil)
    ...
    <div class="container">
        ...
        <form action="pegawai_controller.php" method="POST" class="row">
            ...
            <div class="col-md-12">
                ...
                <textarea name="alamat" id="alamat" class="form-control main" rows="10" placeholder="<?= $peg['alamat'] ?>"
                ></textarea>
            </div>
            <div class="col-12 text-center">
                <?php
