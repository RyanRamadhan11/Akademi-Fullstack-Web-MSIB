...
<section class="section contact-form">
	<div class="container">
		...
		<form action="pegawai_controller.php" method="POST" class="row">
			...
			<div class="col-md-6">
				<input type="text" class="form-control main" name="tmp_lahir" id="tmp_lahir" placeholder="Tempat Lahir">
			</div>
            <div class="col-md-6">
				<input type="date" class="form-control main" name="tgl_lahir" id="tgl_lahir" placeholder="Tanggal Lahir">
			</div>
            <div class="col-md-6">
			...
			<div class="col-12 text-center">
                ...
                <button type="submit" name="proses" value="batal" class="btn btn-main-md">Batal</button>
			</div>
		</form>
	</div>
</section>